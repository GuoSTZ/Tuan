...
var LoginForm = /** @class */ (function (_super) {
    ...
    LoginForm.prototype.renderBody = function () {
        ...
        var formItemLayout = layout && layout !== 'inline'
            ...
            : {};
        return (react_1.default.createElement(react_1.default.Fragment, null, react_1.default.Children.map(this.props.children, function (child) {
            return child && react_1.default.cloneElement(child, __assign({}, formItemLayout));
        })));
    };
    LoginForm.prototype.renderLoginToolbar = function () {
        ...
        return footer ? (footer) : (react_1.default.createElement("div", { className: 'login-submit-wrapper' },
            react_1.default.createElement(antd_1.Button, { htmlType: 'submit', disabled: loading, type: 'primary' }, submitText)));
    };
    LoginForm.prototype.render = function () {
        ...
        return (react_1.default.createElement(components_1.BaseForm, { action: url, method: 'post', name: 'loginForm', layout: layout, autoSubmitForm: autoSubmitForm, className: mergeClassName, onSubmit: this.handleLogin.bind(this), wrappedComponentRef: this.saveFormRef.bind(this) },
            this.renderBody(),
