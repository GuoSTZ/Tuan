...
var UploadFile = /** @class */ (function (_super) {
    ...
    UploadFile.prototype.render = function () {
        ...
        return (React.createElement(Upload, __assign({}, other, { fileList: this.state.fileList, beforeUpload: this.beforeUpload.bind(this), onRemove: this.onRemove.bind(this) }),
