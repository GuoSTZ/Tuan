...
var size = filesize.partial({ base: 2, standard: "jedec" }); // filesize标准设置
export var Echart = function (props) {
    ...
    var someInfo = function () {
        return (React.createElement("div", { className: 'someInfo' },
            peakInfo(),
            React.createElement("div", { style: { clear: 'both' } })));
    };
    var peakInfo = function () {
        return peakValue ? (React.createElement("div", { className: 'allPeak' }, peakValue === null || peakValue === void 0 ? void 0 : peakValue.map(function (peak, index) {
            return (React.createElement(Tooltip, { placement: 'top', title: "\u53D1\u751F\u4E8E" + (peak === null || peak === void 0 ? void 0 : peak.peakTime) },
                React.createElement("div", { className: 'peakValue', onClick: function () {
                        searchPoint(index);
                    } },
                    columnsName[index],
    ...
    var legendUnder = function () {
        return (React.createElement("div", { className: 'legendUnder' }, colors === null || colors === void 0 ? void 0 : colors.map(function (color, index) {
            return (React.createElement("span", null,
                React.createElement("span", { className: 'point', style: { backgroundColor: color } }),
                columnsName[index],
                "\u00A0\u00A0\u00A0\u00A0"));
        })));
    };
    var actions = otherProps.actions, spins = otherProps.spins;
    return (React.createElement(Spin, { spinning: loading || false },
        someInfo(),
        React.createElement("div", { className: 'echartsNode', ref: myRef }),
